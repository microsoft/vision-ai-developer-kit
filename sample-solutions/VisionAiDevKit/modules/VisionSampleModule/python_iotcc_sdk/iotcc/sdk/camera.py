...
class CameraClient():
    ...
    def captureimage(self):
        ...
        with open(r"C:\Users\yadavm\Source\Repos\Peabody\peabody\VisionEdgeSolution1\modules\VisionSampleModule\var\azureml-app\python_iotcc_sdk\tests\cameracapture\foo_{}.jpg".format(timestr),"wb") as f:
             f.write(base64.b64decode(response["Data"]))
             #frame=base64.b64decode(response["Data"])
        #time.sleep(3)
