...
__BASE.MODEL_PATH = "MachineLearning/models/ssd_mobilenet_v1_retrain_poker3/"
__BASE.MODEL_NAME = "frozen_inference_graph.pb"
__BASE.MODEL_TAGS = {"Device": "peabody", "type": "mobilenetssd", "area": "iot", "version": "1.0"}
__BASE.MODEL_DESCRIPTION = "MobileNet V1 SSD retrain by poker3 dataset"
...
__BASE.IMAGE_NAME = "mobilenetssdv1poker3"

# Settings used in IotContainerImage.image_configuration()
__BASE.IMAGE_TAGS = ["mobilenetssd"]
__BASE.IMAGE_DESCRIPTION = "MobileNet V1 SSD retrain by poker3 dataset"

# Settings used in
__BASE.MODULE_NAME = "VisionSampleSSD_V1_retrain"

# Settings used in deployment.json
__BASE.MODULE_NAME = "VisionSampleImagenetSSD_V1_Poker3"
