...
__BASE.MODEL_PATH = "MachineLearning/models/ssd_mobilenet_v2_quantized_retrain_poker3/"
__BASE.MODEL_NAME = "frozen_inference_graph.pb"
__BASE.MODEL_TAGS = {"Device": "peabody", "type": "mobilenetssd", "area": "iot", "version": "1.0"}
__BASE.MODEL_DESCRIPTION = "Quantized MobileNet V2 SSD retrain with poker3 dataset"
...
__BASE.IMAGE_DESCRIPTION = "Quantized MobileNet V2 SSD retrain with poker3 dataset"

# Settings used in deployment.json
__BASE.MODULE_NAME = "VisionSample_SSD_V2_Poker3"
