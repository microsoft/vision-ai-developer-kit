...
def transfervam():
        ...
        dlc_file = find_file(dst, vamconfig["DLC_NAME"])
        label_file = find_file(dst, vamconfig["LABELS_NAME"])
...
# these functions transfer new models to device to location /data/misc/camera mounted at /app/vam_model_folder
